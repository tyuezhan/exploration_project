...
#include <ddk_nav_2d/MoveToPosition2DAction.h>
#include <geometry_msgs/PoseStamped.h>
#include <tf/transform_datatypes.h>

#include <ddk_nav_2d/commands.h>

typedef actionlib::SimpleActionClient<ddk_nav_2d::MoveToPosition2DAction> MoveClient;

MoveClient* gMoveClient;

void receiveGoal(const geometry_msgs::PoseStamped::ConstPtr& msg)
{
	ddk_nav_2d::MoveToPosition2DGoal goal;
